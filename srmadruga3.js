...
function fasetresMadruga() {
    ...
    if (escolha == 1) {
        ...
        document.write(`<div class="texto">
               ...
               <p><a href="3index.html"><button><strong>Novo desafio</strong></button></a></p>
        ...
        document.write(`<div class="texto"><h1><p><strong>Você está na fase 3!<br> Dona Florinda deu um bofetão em Sr Madruga <br>Você perdeu o jogo não tem chororo!</strong><br><h1></div>
         <p><a href="gameo.html"><button><strong>Não quero desafio</strong></button></a></p>
        <p><a href="3index.html"><button><strong>Quero um no desafio</strong></button></a></p>`)
